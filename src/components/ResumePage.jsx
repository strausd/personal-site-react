        ...
        <div className="page">
            ...
            <div className="resume-section">
                ...
                <div className="resume-section-body">
                    ...
                    <p>Automate set assembling and wind simulation tasks using Python scripts</p>
                    <p>Reduce vegetation caching process from 3 hours per asset to 5 minutes and a few button clicks using Python scripts</p>
                    <p>Procedurally generate and style grass for environments using XGen’s expression language</p>
                ...
                <div className="resume-section-body">
                    ...
                    <p>Teach nearly 100 students 3D Modeling and Texturing for the school of Arts and Technology</p>
                </div>
                <div className="resume-section-body">
                    <div className="resume-experience-subhead">
                        <h3>UT Dallas - TA</h3>
                    ...
                    <p>Teach two semesters of 3D Rigging including MEL scripting for the school of Arts and Technology</p>
